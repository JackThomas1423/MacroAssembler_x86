...
%token <num> NUMBER
%token <str> FUNC LABEL STRING
%token COMMA COLON NEWLINE
%token <str> LBRACKET RBRACKET LPAREN RPAREN
%token PLUS MINUS MULTIPLY DIVIDE

/* Type declarations for nonterminals */
%type <str> instruction zero_operand_mnem one_operand_mnem two_operand_mnem label operand memory_operand
